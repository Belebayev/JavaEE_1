                    ...
                    <form action="/addItem" method="post">
                        ...
                        <div style="text-align: right;">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                                    style="padding: 10px 20px; margin-right: 10px; border: none; background: #ccc; border-radius: 5px; font-size: 16px; cursor: pointer;">
                                Закрыть
                            </button>
                            <button type="submit" class="btn btn-success"
                                    style="padding: 10px 20px; border: none; background: #28a745; color: white; border-radius: 5px; font-size: 16px; cursor: pointer;">
                                Добавить
                            </button>
                        </div>
                    </form>
